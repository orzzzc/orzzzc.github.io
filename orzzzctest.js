...
function ORZINF(){
    ...
    if(dianji%10==changedianji)document.getElementById("zzcsays").innerHTML='zzc：'+sayslist[Math.floor(Math.random()*sayslist.length)],changedianji=0;
    ...
    testcookie=getCookie('mobaishuliang');
    document.getElementById("zzcsays2").innerHTML=testcookie;
